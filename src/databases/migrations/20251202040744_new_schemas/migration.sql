...
CREATE TABLE "tickets" (
    "id" TEXT NOT NULL,
    "user_id" TEXT,
    "return_schedule_id" TEXT,
    "outbound_schedule_id" TEXT,
...
-- AddForeignKey
ALTER TABLE "ports" ADD CONSTRAINT "ports_island_id_fkey" FOREIGN KEY ("island_id") REFERENCES "islands"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "routes"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_ferry_id_fkey" FOREIGN KEY ("ferry_id") REFERENCES "ferries"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "passengers" ADD CONSTRAINT "passengers_ticket_id_fkey" FOREIGN KEY ("ticket_id") REFERENCES "tickets"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "seat_holds" ADD CONSTRAINT "seat_holds_schedule_id_fkey" FOREIGN KEY ("schedule_id") REFERENCES "schedules"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_return_schedule_id_fkey" FOREIGN KEY ("return_schedule_id") REFERENCES "schedules"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_outbound_schedule_id_fkey" FOREIGN KEY ("outbound_schedule_id") REFERENCES "schedules"("id") ON DELETE SET NULL ON UPDATE CASCADE;
